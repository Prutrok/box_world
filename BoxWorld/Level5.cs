...
namespace BoxWorld
{
    public partial class Level5 : Form
    {
        ...
        private void Level5_KeyPress(object sender, KeyPressEventArgs e)
        {
      ...
      private void Level5_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (!Helper.popUp.isExitCalledFromHere && !didWin)
            {
                e.Cancel = true;
                Helper.popUp.FormState.level = "Level5";
